...
The current maintained release is [YTM Desktop v3.0.6](https://github.com/Lostepic/ytmdesktop/releases/latest).
...
Windows users should download `YTM.Desktop-3.0.6.Setup.exe`. The `.nupkg` and `RELEASES` files are updater metadata and are not manual installers.
