...
.ytmview-loading-container {
  ...
  background: radial-gradient(circle at 50% 38%, rgba(255, 44, 72, 0.16), transparent 32%), linear-gradient(145deg, #0c0c12 0%, #151019 100%);
}
...
.loader-line {
  ...
  height: 4px;
  border-radius: 10px;
  background: linear-gradient(180deg, #ff6672, #ed3345);
  box-shadow: 0 0 14px rgba(255, 64, 82, 0.38);
